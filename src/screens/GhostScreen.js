...
const styles = StyleSheet.create({
  ...
  statusBox: { width: '80%', padding: 20, backgroundColor: '#030303', borderRadius: 5, borderWidth: 1, borderColor: '#00ff0022' },
  statusText: { color: '#666', fontSize: 9, marginBottom: 5, letterSpacing: 1 },
  val: { color: '#00ff00' },
